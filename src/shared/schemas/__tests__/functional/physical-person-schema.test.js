...
const { validPhysicalPersonFixture } = require('../__fixtures__');
...
test.before('prepare: connect to database', (t) => {
	return database.connect();
});
test.beforeEach('cleanup database', (t) => {
	return PhysicalPerson.deleteMany();
});
